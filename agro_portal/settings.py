...
# Read SECRET_KEY from environment variable, fallback to local dev key
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-your-secret-key-here')

# Read DEBUG status dynamically (False on production, True locally)
DEBUG = os.environ.get('DEBUG', 'True') == 'True'

# Allow Render host as well as localhost
ALLOWED_HOSTS = ['*']
...
# Static files configuration (WhiteNoise compression enabled)
STATIC_URL = '/static/'
